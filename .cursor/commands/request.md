...
- **Directive:** Execute your plan incrementally. Adhere strictly to all protocols defined in your **Operational Doctrine** and project rules.
...
- **Verification Steps:**
  1. Execute all relevant quality gates (lint, format, test per `.cursor/preflight.json` or project norms).
